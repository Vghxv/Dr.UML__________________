...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 2.c User can modify the color of a Gadget. The color will apply to the outline and texts.
        ...
        \item 4.d When multiple Associations are created between two Gadgets, System will automatically distinguish the different paths to prevent overlap.
        \item 4.e User can modify the path of an Association.
    \end{itemize}
...
\begin{figure}[H]
  \centering
    \includesvg[inkscapelatex=false,height=0.5\textheight]{assets/hw3/dmWithAss}
...
\begin{figure}[H]
  \centering
    \includesvg[inkscapelatex=false,height=0.4\textheight]{assets/hw3/dmWithAssAndAtt}
...
\begin{figure}[H]
  \centering
    \includesvg[inkscapelatex=false,height=0.45\textheight]{assets/hw4/dcd}
