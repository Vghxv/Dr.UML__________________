...
const GadgetPropertiesPanel: React.FC<GadgetPropertiesPanelProps> = ({
    selectedComponent: selectedGadget,
    ...
    // 型別守衛：判斷是否為 GadgetProps
    function isGadgetProps(obj: any): obj is GadgetProps {
        return obj && Array.isArray(obj.attributes);
    }

    if (isGadgetProps(selectedGadget)) {
        // GadgetProps 的處理
        return (
